...
For current or changing information, use the supplied live web search results.
...
- Do NOT return JSON.
- Do NOT return an object such as {"reply":"..."}.
- Do NOT include "reply:" before the answer.
- Do NOT include conversationId.
- Do NOT use escaped newline characters such as \\n.
...
app.listen(PORT, "0.0.0.0", () => {
    ...
    console.log(
        `Mining Discovery AI server running at http://192.168.1.8:${PORT}`
    );
